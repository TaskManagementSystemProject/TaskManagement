...
public class ShowTeamMembersCommand implements Command {
    ...
    private static final String TEAM_MEMBERS_PREFIX_MESSAGE = "MEMBERS in team %s:%n%s";
    ...
    public String execute(List<String> parameters) {
        ...
        return toReturnMessage.isEmpty() ?
                String.format(NO_MEMBERS_MESSAGE_IN_TEAM, teamName) :
                String.format(TEAM_MEMBERS_PREFIX_MESSAGE, teamName, toReturnMessage);
    }
}
